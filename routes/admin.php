...
Route::group(['prefix'  =>  'admin'], function () {
    ...
    Route::group(['middleware' => ['auth:admin']], function () {
        ...
        Route::group(['prefix' => 'sellers'], function () {
            Route::get('/', 'Admin\SellersController@index')->name('admin.sellers.index');
        });


        Route::group(['prefix' => 'shops'], function () {
            Route::get('/', 'Admin\ShopsController@index')->name('admin.shops.index');
        });

            Route::get('/all admins', 'Admin\UsersController@indexAdmin')->name('admin.show.index');

        Route::group(['prefix' => 'transactions'], function () {
            Route::get('orders','Admin\TransactionsController@bookings')->name('admin.transactions.bookings');
            Route::get('subscriptions','Admin\TransactionsController@subscriptions')->name('admin.transactions.subscription');
        });
