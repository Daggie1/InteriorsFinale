...
class CategoryController extends BaseController
{
    ...
    public function store(Request $request)
    {
        ...
        if($parent_category->level>2){
            return  $this->responseRedirectBack("The paren't category selected is wrong",'error',true,true);
        }
      $request['level']=$parent_category->level+1;
