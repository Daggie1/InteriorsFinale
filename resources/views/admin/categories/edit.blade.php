            ...
            <div class="tile">
                ...
                <form action="{{ route('admin.categories.update') }}" method="POST" role="form" enctype="multipart/form-data">
                    ...
                    <div class="tile-body">
                        ...
                        <div class="form-group">
                            <label class="control-label" for="quantity">hierarchy Level</label>
                            <input
                                ...
                                id="level"
                                name="Level"
                                value="{{ $targetCategory->level}}"
                            />
                            <div class="invalid-feedback active">
                                <i class="fa fa-exclamation-circle fa-fw"></i> @error('level') <span>{{ $message }}</span> @enderror
                            </div>
                        </div>
                        <div class="form-group">
