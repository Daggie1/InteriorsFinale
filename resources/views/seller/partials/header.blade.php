<header class="app-header">
    <a class="app-header__logo" href="#">{{ auth()->user()->name}}</a>
    ...
    <ul class="app-nav">
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu settings-menu dropdown-menu-right">
                {{--<li>--}}
                    {{--<a class="dropdown-item" href="{{ route('') }}"><i class="fa fa-cog fa-lg"></i> Settings</a>--}}
                {{--</li>            --}}
                <li>
                    <a class="dropdown-item" href="#"><i class="fa fa-user fa-lg"></i> Profile</a>
                </li>
                <li>
                    <a class="dropdown-item" href="{{ route('seller.logout') }}"><i class="fa fa-sign-out fa-lg"></i> Logout</a>
                </li>
            </ul>
        </li>
    </ul>
