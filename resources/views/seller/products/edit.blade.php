        ...
        <div class="col-md-9">
            <div class="tab-content">
                <div class="tab-pane active" id="general">
                    <div class="tile">
                        <form action="{{ route('seller.products.update') }}" method="POST" role="form">
                            @csrf
                            ...
                            <div class="tile-footer">
                                <div class="row d-print-none mt-2">
                                    <div class="col-12 text-right">
                                        ...
                                        <a class="btn btn-danger" href="{{ route('seller.products.index') }}"><i class="fa fa-fw fa-lg fa-arrow-left"></i>Go Back</a>
                                    </div>
                                </div>
                            </div>
                        </form>
                                        ...
                                        <div class="col-md-3">
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <a class="card-link float-right text-danger" href="{{ route('seller.products.images.delete', $image->id) }}">
    ...
    <script>
        ...
        $( document ).ready(function() {
            ...
            let myDropzone = new Dropzone("#dropzone", {
                ...
                url: "{{ route('seller.products.images.upload') }}",
