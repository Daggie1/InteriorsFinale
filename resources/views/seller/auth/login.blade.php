...
<section class="login-content">
    ...
    <div class="login-box">
        <form class="login-form" action="{{ route('seller.login.post') }}" method="POST" role="form">
            @csrf
            ...
            Don't have an account?<span class="text-info"> <a href="{{route('seller.register')}}">Register</a> </span>
        </form>
